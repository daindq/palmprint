# -*- coding: UTF-8 -*-
'''
Kekre, H. B., Sarode, T., & Vig, R. (2012, October). 
An effectual method for extraction of ROI of palmprints. 
In 2012 International Conference on Communication, Information & Computing Technology (ICCICT) (pp. 1-5). IEEE.
Source: https://github.com/yyaddaden/PROIE/tree/main with some modification...
'''
import cv2
...
class PROIE():
    ...
    def _contours(self):
        ...
        self.contour_img = cv2.drawContours(
            self.contour_img, [self.contours], -1, (225, 0, 0), 2)
